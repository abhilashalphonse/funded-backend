...
const env = Object.freeze({
  ...
  ACG_SNAPSHOT_PROJECTION_RETRY_MS: positiveInt("ACG_SNAPSHOT_PROJECTION_RETRY_MS", 5000),
  ACG_COMMAND_RECOVERY_INTERVAL_MS: positiveInt("ACG_COMMAND_RECOVERY_INTERVAL_MS", 30000),

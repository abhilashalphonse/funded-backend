    ...
    res.json({
      ...
      data: {
        services: [
          ...
          { name: "Rupex", status: upiGateways.find(item => item.id === "rupex")?.status || "NOT_CONFIGURED" },
          { name: "Sunpay", status: upiGateways.find(item => item.id === "sunpay")?.status || "NOT_INTEGRATED" },
